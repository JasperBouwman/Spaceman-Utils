package com.spaceman.fancyMessage;
...
public class Keybinds {
    ...
    public static final String HOTBAR1 = "key.hotbar.1";
    public static final String HOTBAR2 = "key.hotbar.2";
    public static final String HOTBAR3 = "key.hotbar.3";
    public static final String HOTBAR4 = "key.hotbar.4";
    public static final String HOTBAR5 = "key.hotbar.5";
    public static final String HOTBAR6 = "key.hotbar.6";
    public static final String HOTBAR7 = "key.hotbar.7";
    public static final String HOTBAR8 = "key.hotbar.8";
